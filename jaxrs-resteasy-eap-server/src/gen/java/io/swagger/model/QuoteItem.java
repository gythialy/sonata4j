...
public class QuoteItem {
    ...
    private List<ProductOfferingQualificationRef> qualification = new ArrayList<ProductOfferingQualificationRef>();
    private List<QuotePrice> quoteItemPrice = new ArrayList<QuotePrice>();
