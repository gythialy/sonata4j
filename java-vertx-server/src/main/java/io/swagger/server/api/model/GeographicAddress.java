...
public class GeographicAddress   {
  ...
  public GeographicAddress (String schemaLocation, String type, Boolean allowsNewSite, FieldedAddress fieldedAddress, FormattedAddress formattedAddress, GeographicLocation geographicLocation, Boolean hasPublicSite, String id, ReferencedAddress referencedAddress) {
