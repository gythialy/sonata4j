...
public class FieldedAddress  {
  ...
  **/
  ...
  public FieldedAddress geographicSubAddress(List<GeographicSubAddress> geographicSubAddress) {
    this.geographicSubAddress = geographicSubAddress;
    return this;
  }

  public FieldedAddress addGeographicSubAddressItem(GeographicSubAddress geographicSubAddressItem) {
  ...
  **/
  ...
  public FieldedAddress id(String id) {
    this.id = id;
    return this;
  }
