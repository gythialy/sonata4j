 ...
 *
 * API tests for GeographicAddressApi 
 */
public class GeographicAddressApiTest {


    private GeographicAddressApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://serverRoot/api/mef", GeographicAddressApi.class, providers);
     ...
     */
    @Test
    public void geographicAddressGetTest() {
        String geographicAddressId = null;
        //GeographicAddress response = api.geographicAddressGet(geographicAddressId);
