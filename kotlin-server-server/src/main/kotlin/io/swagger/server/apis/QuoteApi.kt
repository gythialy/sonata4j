...
fun Route.QuoteApi() {
    ...
    route("/quoteManagement/v2/quote") {
        post {
            ...
            if (principal == null) {
                ...
                val exampleContentString = """{
                  "expectedQuoteCompletionDate" : "2000-01-23",
                  "note" : [ {
                  ...
                  "requestedQuoteCompletionDate" : "2000-01-23T04:56:07.000+00:00",
                  "validFor" : {
                    "startDateTime" : "2000-01-23T04:56:07.000+00:00",
                    "endDateTime" : "2000-01-23T04:56:07.000+00:00"
                  },
                  "@type" : "@type",
                  "expectedFulfillmentStartDate" : "2000-01-23",
                  ...
                  "effectiveQuoteCompletionDate" : "2000-01-23T04:56:07.000+00:00",
                  "@baseType" : "@baseType",
                  "quoteLevel" : { },
                  ...
                  "@schemaLocation" : "@schemaLocation",
                  "projectId" : "projectId",
                  "quoteDate" : "2000-01-23T04:56:07.000+00:00"
                }"""
            ...
            .apply {
                ...
                try {
                    ...
                    application.environment.log.warn("authentication block for '/quoteManagement/v2/quote' is duplicated in code. " +
                            "Generated endpoints may need to be merged under a 'route' entry.")
                }
            }

    get<Paths.quoteFind> { it: Paths.quoteFind ->
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()
        ...
        if (principal == null) {
            ...
            .apply {
                ...
                try {
                    authentication {
                        oauthAtLocation<Paths.quoteFind>(client, ApplicationExecutors.asCoroutineDispatcher(),
    ...
    get<Paths.quoteGet> { it: Paths.quoteGet ->
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()
        ...
        if (principal == null) {
            ...
            .apply {
                ...
                try {
                    authentication {
                        oauthAtLocation<Paths.quoteGet>(client, ApplicationExecutors.asCoroutineDispatcher(),
                                providerLookup = { ApplicationAuthProviders["bearer"] },
                                urlProvider = { currentLocation, provider ->
                                    // TODO: define a callback url here.
                                    "/"
                    ...
                    application.environment.log.warn("authentication block for '/quoteManagement/v2/quote/{id}' is duplicated in code. " +
                            "Generated endpoints may need to be merged under a 'route' entry.")
                }
            }

    route("/quoteManagement/v2/quote/requestStateChange") {
        post {
            val principal = call.authentication.principal<OAuthAccessTokenResponse>()
            ...
            if (principal == null) {
                ...
                val exampleContentType = "application/json;charset=utf-8"
                val exampleContentString = """{
                  "quoteEffectiveStateChangeDate" : "2000-01-23T04:56:07.000+00:00",
                  "externalId" : "externalId",
                  "id" : "id",
                  "state" : { }
                }"""
            ...
            .apply {
                ...
                try {
                    ...
                    application.environment.log.warn("authentication block for '/quoteManagement/v2/quote/requestStateChange' is duplicated in code. " +
                            "Generated endpoints may need to be merged under a 'route' entry.")
                }
            }
}
