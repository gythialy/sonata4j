...
fun Route.ProductOfferingQualificationApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    route("/productOfferingQualificationManagement/v3/productOfferingQualification") {
        post {
            ...
            .apply {
                ...
                try {
                    ...
                    application.environment.log.warn("authentication block for '/productOfferingQualificationManagement/v3/productOfferingQualification' is duplicated in code. " +
                            "Generated endpoints may need to be merged under a 'route' entry.")
                }
            }

    get<Paths.productOfferingQualificationFind> { it: Paths.productOfferingQualificationFind ->
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()
        ...
        if (principal == null) {
            ...
            .apply {
                ...
                try {
                    authentication {
                        oauthAtLocation<Paths.productOfferingQualificationFind>(client, ApplicationExecutors.asCoroutineDispatcher(),
    ...
    get<Paths.productOfferingQualificationGet> { it: Paths.productOfferingQualificationGet ->
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()
        ...
        if (principal == null) {
            ...
            .apply {
                ...
                try {
                    authentication {
                        oauthAtLocation<Paths.productOfferingQualificationGet>(client, ApplicationExecutors.asCoroutineDispatcher(),
                                providerLookup = { ApplicationAuthProviders["bearer"] },
                                urlProvider = { currentLocation, provider ->
                                    // TODO: define a callback url here.
                                    "/"
                    ...
                    application.environment.log.warn("authentication block for '/productOfferingQualificationManagement/v3/productOfferingQualification/{ProductOfferingQualificationId}' is duplicated in code. " +
                            "Generated endpoints may need to be merged under a 'route' entry.")
                }
            }
}
