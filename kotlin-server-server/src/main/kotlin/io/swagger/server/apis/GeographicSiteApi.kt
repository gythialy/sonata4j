...
fun Route.GeographicSiteApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    get<Paths.geographicSiteFind> { it: Paths.geographicSiteFind ->
        ...
        if (principal == null) {
            ...
            .apply {
                ...
                try {
                    authentication {
                        oauthAtLocation<Paths.geographicSiteFind>(client, ApplicationExecutors.asCoroutineDispatcher(),
                    ...
                    application.environment.log.warn("authentication block for '/geographicSiteManagement/v3/geographicSite' is duplicated in code. " +
                            "Generated endpoints may need to be merged under a 'route' entry.")
                }
            }

    get<Paths.geographicSiteGet> { it: Paths.geographicSiteGet ->
        val principal = call.authentication.principal<OAuthAccessTokenResponse>()
        ...
        if (principal == null) {
            ...
            .apply {
                ...
                try {
                    authentication {
                        oauthAtLocation<Paths.geographicSiteGet>(client, ApplicationExecutors.asCoroutineDispatcher(),
                                providerLookup = { ApplicationAuthProviders["bearer"] },
                                urlProvider = { currentLocation, provider ->
                                    // TODO: define a callback url here.
                                    "/"
                    ...
                    application.environment.log.warn("authentication block for '/geographicSiteManagement/v3/geographicSite/{SiteId}' is duplicated in code. " +
                            "Generated endpoints may need to be merged under a 'route' entry.")
                }
            }
}
