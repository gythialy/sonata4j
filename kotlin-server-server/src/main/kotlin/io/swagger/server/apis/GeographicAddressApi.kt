...
fun Route.GeographicAddressApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    get<Paths.geographicAddressGet> { it: Paths.geographicAddressGet ->
        ...
        if (principal == null) {
            ...
            .apply {
                ...
                try {
                    authentication {
                        oauthAtLocation<Paths.geographicAddressGet>(client, ApplicationExecutors.asCoroutineDispatcher(),
                    ...
                    application.environment.log.warn("authentication block for '/geographicAddressManagement/v3/geographicAddress/{GeographicAddressId}' is duplicated in code. " +
