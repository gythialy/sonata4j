...
val ApplicationAuthProviders: Map<String, OAuthServerSettings> = listOf<OAuthServerSettings>(
        OAuthServerSettings.OAuth2ServerSettings(
                name = "bearer",
                authorizeUrl = "https://dummy.oauth.net/auth",
                accessTokenUrl = "https://dumy.oauth.net/token",
                requestMethod = HttpMethod.Get,
                clientId = settings.property("auth.oauth.bearer.clientId").getString(),
                clientSecret = settings.property("auth.oauth.bearer.clientSecret").getString(),
                defaultScopes = listOf("customer", "admin")
        )
//        OAuthServerSettings.OAuth2ServerSettings(
//                name = "facebook",
